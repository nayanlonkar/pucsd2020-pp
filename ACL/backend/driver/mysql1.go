...
func GetUserByGId(conn *sql.DB, object model.IModel, id int64) ([]interface{}, error) {
	rValue := reflect.ValueOf(object)
	rType := reflect.TypeOf(object)
	...
	// queryBuffer.WriteString("SELECT ")
	// queryBuffer.WriteString(strings.Join(columns, ", "))
	queryBuffer.WriteString("SELECT user_id")
	queryBuffer.WriteString(" FROM ")
	queryBuffer.WriteString(object.Table())
	queryBuffer.WriteString(" WHERE group_id = ?")
...
// get all files by parent id
func GetFilesByPId(conn *sql.DB, object model.IModel, id int64) ([]interface{}, error) {
	rValue := reflect.ValueOf(object)
	rType := reflect.TypeOf(object)
	...
	// queryBuffer.WriteString("SELECT ")
	// queryBuffer.WriteString(strings.Join(columns, ", "))
	queryBuffer.WriteString("SELECT file_name, file_type")
	queryBuffer.WriteString(" FROM files")
	// queryBuffer.WriteString(object.Table())
	queryBuffer.WriteString(" WHERE parent_id = ?")
